...
Wuth `gt` can construct a wide variety of useful tables with a cohesive set of table parts. Here is the main workflow:
...
Checkout the `gt` website to know more: <https://gt.rstudio.com/articles/gt.html>
